...
const Presenter = ({actions:{playerActions:{previousTrack, nextTrack,togglePlaying, volumeDown, volumeUp, playTrack}, trackActions}, nextHref, tracks, activeTrack, playing, volume}) => {
